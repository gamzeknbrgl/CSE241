...
double Rectangle::total_area_f(Rectangle &my_rect){

 	total_area+=(my_rect.width*my_rect.height);
 	return total_area;

 }


double Rectangle::total_perimeter_f(Rectangle &my_rect){

 	total_perimeter+=((my_rect.width+my_rect.height)*2);
